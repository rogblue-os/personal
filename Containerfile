...
RUN rpm-ostree override replace https://repos.fedorapeople.org/repos/thl/kernel-vanilla-mainline/fedora-37/x86_64/kernel-6.1.0-65.vanilla.1.fc37.x86_64.rpm
RUN rpm-ostree override replace https://repos.fedorapeople.org/repos/thl/kernel-vanilla-mainline/fedora-37/x86_64/kernel-core-6.1.0-65.vanilla.1.fc37.x86_64.rpm
RUN rpm-ostree override replace https://repos.fedorapeople.org/repos/thl/kernel-vanilla-mainline/fedora-37/x86_64/kernel-modules-6.1.0-65.vanilla.1.fc37.x86_64.rpm
RUN rpm-ostree override replace https://repos.fedorapeople.org/repos/thl/kernel-vanilla-mainline/fedora-37/x86_64/kernel-modules-extra-6.1.0-65.vanilla.1.fc37.x86_64.rpm
